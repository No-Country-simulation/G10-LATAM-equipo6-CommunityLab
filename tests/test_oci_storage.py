...
def oci_manager() -> OCIStorageManager:
    ...
    return OCIStorageManager(allow_local_fallback=False)


def test_client_initialization(oci_manager: OCIStorageManager):
...
def test_upload_and_get_asset_package(oci_manager: OCIStorageManager):
